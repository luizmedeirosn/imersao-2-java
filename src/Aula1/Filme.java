...
public class Filme {
    ...
    public Filme(String titulo, String poster, String nota) {
        this.titulo = titulo;
        this.poster = poster;
        this.nota = nota;
    }
    ...
    public String toString() {
        ...
        saida.append( String.format(alerta + amarelo + negrito + "  Poster " + branco + "%s%s%n", getPoster(), reset) );
